 ...
 */
const t="undefined"!=typeof window&&null!=window.customElements&&void 0!==window.customElements.polyfillWrapFlushCallback,i=(t,i,e=null)=>{for(;i!==e;){const e=i.nextSibling;t.removeChild(i),i=e}},e=`{{lit-${String(Math.random()).slice(2)}}}`,s=`\x3c!--${e}--\x3e`,o=new RegExp(`${e}|${s}`);class n{constructor(t,i){this.parts=[],this.element=i;const s=[],n=[],h=document.createTreeWalker(i.content,133,null,!1);let a=0,d=-1,u=0;const{strings:m,values:{length:A}}=t;for(;u<A;){const t=h.nextNode();if(null!==t){if(d++,1===t.nodeType){if(t.hasAttributes()){const i=t.attributes,{length:e}=i;let s=0;for(let t=0;t<e;t++)r(i[t].name,"$lit$")&&s++;for(;s-- >0;){const i=m[u],e=l.exec(i)[2],s=e.toLowerCase()+"$lit$",n=t.getAttribute(s);t.removeAttribute(s);const r=n.split(o);this.parts.push({type:"attribute",index:d,name:e,strings:r}),u+=r.length-1}}"TEMPLATE"===t.tagName&&(n.push(t),h.currentNode=t.content)}else if(3===t.nodeType){const i=t.data;if(i.indexOf(e)>=0){const e=t.parentNode,n=i.split(o),h=n.length-1;for(let i=0;i<h;i++){let s,o=n[i];if(""===o)s=c();else{const t=l.exec(o);null!==t&&r(t[2],"$lit$")&&(o=o.slice(0,t.index)+t[1]+t[2].slice(0,-"$lit$".length)+t[3]),s=document.createTextNode(o)}e.insertBefore(s,t),this.parts.push({type:"node",index:++d})}""===n[h]?(e.insertBefore(c(),t),s.push(t)):t.data=n[h],u+=h}}else if(8===t.nodeType)if(t.data===e){const i=t.parentNode;null!==t.previousSibling&&d!==a||(d++,i.insertBefore(c(),t)),a=d,this.parts.push({type:"node",index:d}),null===t.nextSibling?t.data="":(s.push(t),d--),u++}else{let i=-1;for(;-1!==(i=t.data.indexOf(e,i+1));)this.parts.push({type:"node",index:-1}),u++}}else h.currentNode=n.pop()}for(const t of s)t.parentNode.removeChild(t)}}const r=(t,i)=>{const e=t.length-i.length;return e>=0&&t.slice(e)===i},h=t=>-1!==t.index,c=()=>document.createComment(""),l=/([ \x09\x0a\x0c\x0d])([^\0-\x1F\x7F-\x9F "'>=/]+)([ \x09\x0a\x0c\x0d]*=[ \x09\x0a\x0c\x0d]*(?:[^ \x09\x0a\x0c\x0d"'`<>=]*|"[^"]*|'[^']*))$/;function a(t,i){const{element:{content:e},parts:s}=t,o=document.createTreeWalker(e,133,null,!1);let n=u(s),r=s[n],h=-1,c=0;const l=[];let a=null;for(;o.nextNode();){h++;const t=o.currentNode;for(t.previousSibling===a&&(a=null),i.has(t)&&(l.push(t),null===a&&(a=t)),null!==a&&c++;void 0!==r&&r.index===h;)r.index=null!==a?-1:r.index-c,n=u(s,n),r=s[n]}l.forEach(t=>t.parentNode.removeChild(t))}const d=t=>{let i=11===t.nodeType?0:1;const e=document.createTreeWalker(t,133,null,!1);for(;e.nextNode();)i++;return i},u=(t,i=-1)=>{for(let e=i+1;e<t.length;e++){const i=t[e];if(h(i))return e}return-1};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
const m=new WeakMap,A=t=>"function"==typeof t&&m.has(t),p={},f={};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
class g{constructor(t,i,e){this.t=[],this.template=t,this.processor=i,this.options=e}update(t){let i=0;for(const e of this.t)void 0!==e&&e.setValue(t[i]),i++;for(const t of this.t)void 0!==t&&t.commit()}_clone(){const i=t?this.template.element.content.cloneNode(!0):document.importNode(this.template.element.content,!0),e=[],s=this.template.parts,o=document.createTreeWalker(i,133,null,!1);let n,r=0,c=0,l=o.nextNode();for(;r<s.length;)if(n=s[r],h(n)){for(;c<n.index;)c++,"TEMPLATE"===l.nodeName&&(e.push(l),o.currentNode=l.content),null===(l=o.nextNode())&&(o.currentNode=e.pop(),l=o.nextNode());if("node"===n.type){const t=this.processor.handleTextExpression(this.options);t.insertAfterNode(l.previousSibling),this.t.push(t)}else this.t.push(...this.processor.handleAttributeExpressions(l,n.name,n.strings,this.options));r++}else this.t.push(void 0),r++;return t&&(document.adoptNode(i),customElements.upgrade(i)),i}}
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const b=` ${e} `;class y{constructor(t,i,e,s){this.strings=t,this.values=i,this.type=e,this.processor=s}getHTML(){const t=this.strings.length-1;let i="",o=!1;for(let n=0;n<t;n++){const t=this.strings[n],r=t.lastIndexOf("\x3c!--");o=(r>-1||o)&&-1===t.indexOf("--\x3e",r+1);const h=l.exec(t);i+=null===h?t+(o?b:s):t.substr(0,h.index)+h[1]+h[2]+"$lit$"+h[3]+e}return i+=this.strings[t],i}getTemplateElement(){const t=document.createElement("template");return t.innerHTML=this.getHTML(),t}}
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const x=t=>null===t||!("object"==typeof t||"function"==typeof t),w=t=>Array.isArray(t)||!(!t||!t[Symbol.iterator]);class v{constructor(t,i,e){this.dirty=!0,this.element=t,this.name=i,this.strings=e,this.parts=[];for(let t=0;t<e.length-1;t++)this.parts[t]=this._createPart()}_createPart(){return new S(this)}_getValue(){const t=this.strings,i=t.length-1;let e="";for(let s=0;s<i;s++){e+=t[s];const i=this.parts[s];if(void 0!==i){const t=i.value;if(x(t)||!w(t))e+="string"==typeof t?t:String(t);else for(const i of t)e+="string"==typeof i?i:String(i)}}return e+=t[i],e}commit(){this.dirty&&(this.dirty=!1,this.element.setAttribute(this.name,this._getValue()))}}class S{constructor(t){this.value=void 0,this.committer=t}setValue(t){t===p||x(t)&&t===this.value||(this.value=t,A(t)||(this.committer.dirty=!0))}commit(){for(;A(this.value);){const t=this.value;this.value=p,t(this)}this.value!==p&&this.committer.commit()}}class k{constructor(t){this.value=void 0,this.i=void 0,this.options=t}appendInto(t){this.startNode=t.appendChild(c()),this.endNode=t.appendChild(c())}insertAfterNode(t){this.startNode=t,this.endNode=t.nextSibling}appendIntoPart(t){t.s(this.startNode=c()),t.s(this.endNode=c())}insertAfterPart(t){t.s(this.startNode=c()),this.endNode=t.endNode,t.endNode=this.startNode}setValue(t){this.i=t}commit(){if(null===this.startNode.parentNode)return;for(;A(this.i);){const t=this.i;this.i=p,t(this)}const t=this.i;t!==p&&(x(t)?t!==this.value&&this.o(t):t instanceof y?this.h(t):t instanceof Node?this.l(t):w(t)?this.u(t):t===f?(this.value=f,this.clear()):this.o(t))}s(t){this.endNode.parentNode.insertBefore(t,this.endNode)}l(t){this.value!==t&&(this.clear(),this.s(t),this.value=t)}o(t){const i=this.startNode.nextSibling,e="string"==typeof(t=null==t?"":t)?t:String(t);i===this.endNode.previousSibling&&3===i.nodeType?i.data=e:this.l(document.createTextNode(e)),this.value=t}h(t){const i=this.options.templateFactory(t);if(this.value instanceof g&&this.value.template===i)this.value.update(t.values);else{const e=new g(i,t.processor,this.options),s=e._clone();e.update(t.values),this.l(s),this.value=e}}u(t){Array.isArray(this.value)||(this.value=[],this.clear());const i=this.value;let e,s=0;for(const o of t)e=i[s],void 0===e&&(e=new k(this.options),i.push(e),0===s?e.appendIntoPart(this):e.insertAfterPart(i[s-1])),e.setValue(o),e.commit(),s++;s<i.length&&(i.length=s,this.clear(e&&e.endNode))}clear(t=this.startNode){i(this.startNode.parentNode,t.nextSibling,this.endNode)}}class C{constructor(t,i,e){if(this.value=void 0,this.i=void 0,2!==e.length||""!==e[0]||""!==e[1])throw new Error("Boolean attributes can only contain a single expression");this.element=t,this.name=i,this.strings=e}setValue(t){this.i=t}commit(){for(;A(this.i);){const t=this.i;this.i=p,t(this)}if(this.i===p)return;const t=!!this.i;this.value!==t&&(t?this.element.setAttribute(this.name,""):this.element.removeAttribute(this.name),this.value=t),this.i=p}}class R extends v{constructor(t,i,e){super(t,i,e),this.single=2===e.length&&""===e[0]&&""===e[1]}_createPart(){return new B(this)}_getValue(){return this.single?this.parts[0].value:super._getValue()}commit(){this.dirty&&(this.dirty=!1,this.element[this.name]=this._getValue())}}class B extends S{}let M=!1;(()=>{try{const t={get capture(){return M=!0,!1}};window.addEventListener("test",t,t),window.removeEventListener("test",t,t)}catch(t){}})();class O{constructor(t,i,e){this.value=void 0,this.i=void 0,this.element=t,this.eventName=i,this.eventContext=e,this.m=t=>this.handleEvent(t)}setValue(t){this.i=t}commit(){for(;A(this.i);){const t=this.i;this.i=p,t(this)}if(this.i===p)return;const t=this.i,i=this.value,e=null==t||null!=i&&(t.capture!==i.capture||t.once!==i.once||t.passive!==i.passive),s=null!=t&&(null==i||e);e&&this.element.removeEventListener(this.eventName,this.m,this.A),s&&(this.A=J(t),this.element.addEventListener(this.eventName,this.m,this.A)),this.value=t,this.i=p}handleEvent(t){"function"==typeof this.value?this.value.call(this.eventContext||this.element,t):this.value.handleEvent(t)}}const J=t=>t&&(M?{capture:t.capture,passive:t.passive,once:t.once}:t.capture)
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */;function j(t){let i=I.get(t.type);void 0===i&&(i={stringsArray:new WeakMap,keyString:new Map},I.set(t.type,i));let s=i.stringsArray.get(t.strings);if(void 0!==s)return s;const o=t.strings.join(e);return s=i.keyString.get(o),void 0===s&&(s=new n(t,t.getTemplateElement()),i.keyString.set(o,s)),i.stringsArray.set(t.strings,s),s}const I=new Map,E=new WeakMap;
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
class{handleAttributeExpressions(t,i,e,s){const o=i[0];if("."===o){return new R(t,i.slice(1),e).parts}return"@"===o?[new O(t,i.slice(1),s.eventContext)]:"?"===o?[new C(t,i.slice(1),e)]:new v(t,i,e).parts}handleTextExpression(t){return new k(t)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */"undefined"!=typeof window&&(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.2.1");const Q=(t,...i)=>new y(t,i,"html",F)
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
const V=t=>i=>"function"==typeof i?((t,i)=>(window.customElements.define(t,i),i))(t,i):((t,i)=>{const{kind:e,elements:s}=i;return{kind:e,elements:s,finisher(i){window.customElements.define(t,i)}}})(t,i),H=(t,i)=>"method"===i.kind&&i.descriptor&&!("value"in i.descriptor)?Object.assign(Object.assign({},i),{finisher(e){e.createProperty(i.key,t)}}):{kind:"field",key:Symbol(),placement:"own",descriptor:{},initializer(){"function"==typeof i.initializer&&(this[i.key]=i.initializer.call(this))},finisher(e){e.createProperty(i.key,t)}};function L(t){return(i,e)=>void 0!==e?((t,i,e)=>{i.constructor.createProperty(e,t)})(t,i,e):H(t,i)}
/**
@license
...
var it=function(t,i,e,s){for(var o,n=arguments.length,r=n<3?i:null===s?s=Object.getOwnPropertyDescriptor(i,e):s,h=t.length-1;h>=0;h--)(o=t[h])&&(r=(n<3?o(r):n>3?o(i,e,r):o(i,e))||r);return n>3&&r&&Object.defineProperty(i,e,r),r};let et=class extends tt{constructor(){super(...arguments),this.name="World",this.count=0}render(){return Q`
  ...
  `,it([L()],et.prototype,"name",void 0),it([L({type:Number})],et.prototype,"count",void 0),et=it([V("my-element")],et);customElements.define("lit-media-query",class extends tt{static get properties(){return{query:{type:String},_match:{type:Boolean}}}constructor(){super(),this.query="(max-width:460px)",this._match=!1}render(){return Q`
    <style>
      :host {
        display: none;
      }
 ...
 * http://polymer.github.io/PATENTS.txt
 */
class st{constructor(t){this.classes=new Set,this.changed=!1,this.element=t;const i=(t.getAttribute("class")||"").split(/\s+/);for(const t of i)this.classes.add(t)}add(t){this.classes.add(t),this.changed=!0}remove(t){this.classes.delete(t),this.changed=!0}commit(){if(this.changed){let t="";this.classes.forEach(i=>t+=i+" "),this.element.setAttribute("class",t)}}}const ot=new WeakMap,nt=(rt=t=>i=>{if(!(i instanceof S)||i instanceof B||"class"!==i.committer.name||i.committer.parts.length>1)throw new Error("The `classMap` directive must be used in the `class` attribute and must be the only part in the attribute.");const{committer:e}=i,{element:s}=e;let o=ot.get(i);void 0===o&&(s.setAttribute("class",e.strings.join(" ")),ot.set(i,o=new Set));const n=s.classList||new st(s);o.forEach(i=>{i in t||(n.remove(i),o.delete(i))});for(const i in t){const e=t[i];e!=o.has(i)&&(e?(n.add(i),o.add(i)):(n.remove(i),o.delete(i)))}"function"==typeof n.commit&&n.commit()},(...t)=>{const i=rt(...t);return m.set(i,!0),i});var rt;const ht=_`
.container {
    display: flex;
    flex-direction: row;
...
var ct=function(t,i,e,s){for(var o,n=arguments.length,r=n<3?i:null===s?s=Object.getOwnPropertyDescriptor(i,e):s,h=t.length-1;h>=0;h--)(o=t[h])&&(r=(n<3?o(r):n>3?o(i,e,r):o(i,e))||r);return n>3&&r&&Object.defineProperty(i,e,r),r};let lt=class extends tt{constructor(){super(...arguments),this._query="(max-width: 800px)",this._isMobile=window.visualViewport.width<800,this.image="data:image/png;base64,",this.containerClasses={container:!0,mobile:!1},this.headerClasses={header:!0,"header-mobile":!1},this.data={name:"-Empty name-",description:"-Empty description-",website:"-Empty website url-",repo:null,download:null}}connectedCallback(){super.connectedCallback()}_handleMediaQuery(t){this._isMobile=t.detail.value,this.containerClasses={container:!0,mobile:this._isMobile.valueOf()},this.headerClasses={header:!0,"header-mobile":this._isMobile.valueOf()}}render(){this.containerClasses={container:!0,mobile:this._isMobile.valueOf()},this.headerClasses={header:!0,"header-mobile":this._isMobile.valueOf()};var t=this.data.download?Q`
    ...
    `}};lt.styles=[ht],ct([L()],lt.prototype,"_query",void 0),ct([L()],lt.prototype,"_isMobile",void 0),ct([L()],lt.prototype,"image",void 0),ct([L()],lt.prototype,"containerClasses",void 0),ct([L()],lt.prototype,"headerClasses",void 0),ct([L()],lt.prototype,"data",void 0),lt=ct([V("jwc-project-card")],lt);
/**
 * @license
 * Copyright (c) 2020 Jesidea Authors. All rights reserved.
 */
var at=function(t,i,e,s){for(var o,n=arguments.length,r=n<3?i:null===s?s=Object.getOwnPropertyDescriptor(i,e):s,h=t.length-1;h>=0;h--)(o=t[h])&&(r=(n<3?o(r):n>3?o(i,e,r):o(i,e))||r);return n>3&&r&&Object.defineProperty(i,e,r),r};let dt=class extends tt{constructor(){super(...arguments),this.image=null,this.data={name:"Javier Escacena",username:null,occupation:"Programmer",location:"Cercedilla",company:"@paradigmate",email:"javier.escacena@gmail.com",website:"http://jesidea.com",twitter:"@javiescacena",linkedin:"https://www.linkedin.com/in/jescacena/",github:"jescacena"}}render(){return Q` <div>JESidea user profile ${this.data.name}</div> `}};dt.styles=_`
    :host {
      display: block;
      border: solid 1px gray;
      padding: 16px;
  ...
  `,at([L()],dt.prototype,"image",void 0),at([L()],dt.prototype,"data",void 0),dt=at([V("jwc-user-profile")],dt);const ut=_`
...
var mt=function(t,i,e,s){for(var o,n=arguments.length,r=n<3?i:null===s?s=Object.getOwnPropertyDescriptor(i,e):s,h=t.length-1;h>=0;h--)(o=t[h])&&(r=(n<3?o(r):n>3?o(i,e,r):o(i,e))||r);return n>3&&r&&Object.defineProperty(i,e,r),r};let At=class extends tt{constructor(){super(...arguments),this._query="(max-width: 800px)",this._isMobile=window.visualViewport.width<800,this._isMenuMobileVisible=!1,this.logo="data:image/png;base64,",this.menuItems=[{label:"Home",url:"/home"},{label:"About",url:"/home/about"},{label:"Articles",url:"/home/articles"}]}_handleMediaQuery(t){this._isMobile=t.detail.value}_handleClick(){this._toggleMenuMobile()}_toggleMenuMobile(){this._isMenuMobileVisible=!this._isMenuMobileVisible}renderMenuItems(){return this.menuItems.map(t=>Q`<li>${t.label}  &gt; </li>`)}renderMenu(){return Q`
        ...
        `}};At.styles=[ut],mt([L()],At.prototype,"_query",void 0),mt([L()],At.prototype,"_isMobile",void 0),mt([L()],At.prototype,"_isMenuMobileVisible",void 0),mt([L()],At.prototype,"logo",void 0),mt([L()],At.prototype,"menuItems",void 0),At=mt([V("jwc-layout-header")],At);
/**
 * @license
 * Copyright (c) 2020 Jesidea Authors. All rights reserved.
 */
var pt=function(t,i,e,s){for(var o,n=arguments.length,r=n<3?i:null===s?s=Object.getOwnPropertyDescriptor(i,e):s,h=t.length-1;h>=0;h--)(o=t[h])&&(r=(n<3?o(r):n>3?o(i,e,r):o(i,e))||r);return n>3&&r&&Object.defineProperty(i,e,r),r};let ft=class extends tt{constructor(){super(...arguments),this.icon=null,this.header=null,this.source=[]}render(){return Q` <div>JESidea jwc-quote-random-box</div> `}};ft.styles=_`
    :host {
      display: block;
      border: solid 1px gray;
      padding: 16px;
  ...
  `,pt([L()],ft.prototype,"icon",void 0),pt([L()],ft.prototype,"header",void 0),pt([L()],ft.prototype,"source",void 0),ft=pt([V("jwc-quote-random-box")],ft);export{At as JwcLayoutHeader,lt as JwcProjectCard,ft as JwcQuoteRandomBox,dt as JwcUserProfile,et as MyElement};
